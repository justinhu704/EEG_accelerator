...
module tb_fpga_uart_top;
    ...
    fpga_uart_top #(
        ...
        .CONV1_PW_W_FILE("../mem/dsconv1_dsconv2/weights/conv1_pointwise_W_x3.mem"),
        .CONV1_PW_B_FILE("../mem/dsconv1_dsconv2/weights/conv1_pointwise_b_x3.mem"),
    ...
    initial begin
        ...
        if ($signed({response[9],response[8]}) !== 16'sd29709)
            $fatal(1, "Expected winning logit 29709, received %0d",
