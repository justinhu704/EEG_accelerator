...
module tb_conv3;
    localparam int OUTPUT_SIZE = 18 * 14 * 15;
    ...
    conv_layer_mem #(
        ...
        .BIAS_SHIFT   (12),
        .OUTPUT_SHIFT (17),
        .INPUT_FILE   ("../mem/golden/q_pool1_act.mem"),
        .WEIGHT_FILE  ("../mem/weights/conv3_W.mem"),
        .BIAS_FILE    ("../mem/weights/conv3_b.mem")
    ) dut (
        .clk          (clk),
        .rst_n        (rst_n),
        .start        (start),
    ...
    initial begin
        ...
        $readmemh("../mem/golden/q_conv3_act.mem",
        ...
        if ((error_count == 0) && (checked_count == OUTPUT_SIZE)) begin
            $display("PASS: Conv3 matches MATLAB within 1 LSB.");
            ...
            $display("FAIL: Conv3 verification failed.");
    ...
    always @(posedge clk) begin
        ...
        if (cycle_count > MAX_CYCLES) begin
            $display("FAIL: Conv3 simulation timeout at cycle %0d",
                     cycle_count);
            $finish;
        end
    end
